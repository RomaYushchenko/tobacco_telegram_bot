...
/**
 * Class that represents the processing of the {@link TobaccoCommand} {@link TobaccoBotCommand#LOAD_420_LIGHT} for Admin
 *
...
public class Load420LightCommand implements TobaccoCommand {
    ...
    public BotApiMethod<?> buildMessage(final UserRequestModel model) {
        ...
        final var sendMessage = loadTobaccoBuilder.buildLoad420LightTobacco(model.getChatId(), model.getMessageText());

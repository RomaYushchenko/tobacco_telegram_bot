...
/**
 * Class that represents the processing of the {@link TobaccoCommand} {@link TobaccoBotCommand#LOAD_YUMMY} for Admin
 *
...
public class LoadYummyCommand implements TobaccoCommand {
    ...
    public BotApiMethod<?> buildMessage(final UserRequestModel model) {
        ...
        final var sendMessage = loadTobaccoBuilder.buildLoadYummyTobacco(model.getChatId(), model.getMessageText());
    ...
    public TobaccoBotCommand getCommand() {
        return TobaccoBotCommand.LOAD_YUMMY;
    }
}
